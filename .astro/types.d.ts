...
"even-my-wife-said.md": {
	id: "even-my-wife-said.md";
  slug: "even-my-wife-said";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
...
"why-I-chose-codepen.md": {
	id: "why-I-chose-codepen.md";
  slug: "why-i-chose-codepen";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
"why-should-I-apologize.md": {
	id: "why-should-I-apologize.md";
  slug: "why-should-i-apologize";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
